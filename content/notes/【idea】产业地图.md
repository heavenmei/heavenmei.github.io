...
## 论文
- 语义地图2.0， 利用LLMs的能力来提高语料库和语义相似度测量的质量 --> 语义局部地图
- 输入是产业语料库
...
2. 产业链关系的计算（）
3. 可视化设计
4. 外挂知识库驱动生成产业图谱，有关联关系的数据驱动地图展示

产业态势分布，
评估：

对浪漫和地点的描述扩充，再送到GPT计算相似度
贡献：构建知识库，在这个帮助下做扩充，也可做产业链构建，
语义的提高和产业链的构建
- 地块与地块的区域之间分析：产业链构建串联区域之间关系。
- 更智能的语义计算
...
> UX稿： https://www.figma.com/file/fdcjvVsktoOZ16cYNkGKBL/Industrial-Map?type=design&node-id=0-1&mode=design&t=xU9KqwD9OwjvP07O-0
...
**功能点-产业**
1. 企业区域分布（散点）
2. 企业详细信息（hover）：综合实力、吸引力指数、企业活力，企业规模、企业发展、地位、客户画像
3. 该产业综合指标（侧边栏），Q完备产业集群？指标达成率
4. 企业上下游关系（连接线），G-探索是否存在缺失/弱势企业
5. 语义指标（热力）：舒适度、便捷度、企业实力分布
6. POI（散点）：餐饮、娱乐场所、公共交通……
7. 良好的配套基准（侧边栏）：综合分析缺失配套

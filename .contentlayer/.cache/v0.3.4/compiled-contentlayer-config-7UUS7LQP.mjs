...
var metadata = async (resourcePath, source, pathname) => {
  const content = readFileSync(path.join(process.cwd(), source));
  console.log("staticImages ===", path.join(process.cwd(), source), content);
...
//# sourceMappingURL=compiled-contentlayer-config-7UUS7LQP.mjs.map

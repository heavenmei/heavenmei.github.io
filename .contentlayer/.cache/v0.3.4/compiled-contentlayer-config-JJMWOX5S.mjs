...
var metadata = async (resourcePath, source, pathname) => {
  console.log("staticImages ===", path.join(process.cwd(), source));
  const content2 = await fs.readFile("/public/avatar.jpg");
...
var content = readFileSync(path2.join(process.cwd(), "/public/avatar.jpg"));
...
//# sourceMappingURL=compiled-contentlayer-config-JJMWOX5S.mjs.map

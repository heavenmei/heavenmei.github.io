...
var metadata = async (resourcePath, source, pathname) => {
  const content2 = readFileSync(path.join(process.cwd(), source));
  console.log("staticImages ===", "./" + source, content2);
...
//# sourceMappingURL=compiled-contentlayer-config-263COQWL.mjs.map

...
var findPath = (file, image) => {
  ...
  if (directory && directory !== ".") {
    console.log("staticImages ===", path.join(cwd, directory), image);
    return path.join(cwd, directory, image.properties?.src || "");
  }
...
var staticImages = (
  ...
  (options) => (tree, file, done) => {
    ...
    visit2(tree, "element", (node) => {
      if (node.tagName === "img" && node.properties?.src.includes("://") === -1) {
...
var contentlayer_config_default = makeSource({
  ...
  mdx: {
    ...
    rehypePlugins: [
      [static_images_default, { publicDir: path2.join(process.cwd(), "public/posts") }],
      // preProcess,
      [
        rehypePrettyCode,
        {
...
//# sourceMappingURL=compiled-contentlayer-config-5KGBC4NH.mjs.map
